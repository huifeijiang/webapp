<template>
	<div class="newss">
		<head-dom>新闻</head-dom>
		<!-- <div class="btns-wrap">
			<div class="news-btns">
				<a href="javascript:;" class="btn-n borright active" @click="handleTabChange('tab1')" ref="tab1">新闻</a>
				<a href="javascript:;" class="btn-n" @click="handleTabChange('tab2')" ref="tab2">通知</a>
			</div>
		</div> -->
		<div class="three-img">
			<mt-swipe :auto="5000">
  				<!-- <mt-swipe-item>
  					<div class="swp">
					  	<img src="http://baoan.cityworks.cn:2000/baoan/static/news/river_news/news4.png" />
					  	<div class="shuomin ellipsis">李育基局长率队检查军训筹备工作</div>
					</div>
				</mt-swipe-item>
  				<mt-swipe-item>
  					<div class="swp">
		...
		<!-- <mu-tabs class="news-tab" :value="activeTab" @change="handleTabChange">
		    <mu-tab value="tab1" title="新闻"/>
		    <mu-tab value="tab2" title="通知"/>
	  	</mu-tabs> -->
	  	<div class="news-wrap" ref="newsWrap">
			...
			<div v-else>
			   	<!-- <div class="news-list border-1px f_clear" v-for="item in messageData" @click="toggle(item)">
					<div class="img-wrap">
			    		<img :src="item.titlePic" alt="">
			    	</div>
			    	<div class="rig-con">
						<div class="titlef">{{item.title}}</div>
						<div class="bottom-con f_clear">
							<div class="name  ellipsis f_le">宝安三防区</div>
							<div class="timee f_ri">2017-08-31</div>
						</div>
					</div>
			    </div> -->
			</div>
	  	...
	  	<mu-drawer class="news-alert" right :open="open" @close="toggle()">
		    ...
		    <div class="news-content2" id="newsContent" ref="newsContent">
		    	<!--<p class="alert-p">{{nowItem.title}}</p>-->
		    	<!--<span class="alert-img-title">来源:{{nowItem.source}} 时间:{{nowItem.time}}</span>-->
		    	<!--<div class="alert-img">-->
		    		<!--<img :src="nowItem.image" alt="">-->
		    	<!--</div>-->
		    	<!--<div class="news-detail" v-for="txt in nowItem.context.split('<br>')">{{txt}}</div>-->
                <!--<div class="alert-img" v-for="item in nowItem.images">-->
                    <!--<img :src="item" >-->
                <!--</div>-->
        </div>
