<template>
	<div class="event-wrap">
		...
		<div class="event-status" @click="eventStatusVmodel.show=true" >
		...
		<mu-drawer class="news-alert" right :open="open">
			<handle-detail @toggleOne="backToPage" @toggleTwo="showEvent" :tableData="tableData" :done="eventDone" :doneMess="doneDetail" :showButton="false" :detailImage="detailImage"></handle-detail>
		</mu-drawer>
		<!--end-->
